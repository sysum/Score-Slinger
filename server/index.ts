...
function configureExpoAndLanding(app: express.Application) {
  ...
  if (webBuildExists) {
    log("Serving Expo web build from dist/ for browser visitors");
  } else {
    log("No web build found in dist/, serving Expo Go landing page for browsers");
  }
